...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2015 at 07:50 AM
...
-- Database: `ecpms-sd`
--
CREATE DATABASE IF NOT EXISTS `ecpms-sd` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `ecpms-sd`;
...
CREATE TABLE IF NOT EXISTS `prescription` (
  ...
  KEY `fk_prescription_material1_idx` (`material_id`),
...
ALTER TABLE `prescription`
  ...
  ADD CONSTRAINT `fk_prescription_material1` FOREIGN KEY (`material_id`) REFERENCES `material` (`material_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
